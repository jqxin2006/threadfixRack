	...
	<table>
		<tbody>
			...
			<tr>
				...
				<td style="padding:5px;" class="inputValue">
					<form:input style="width:350px;" id="parameterInput" path="surfaceLocation.parameter" size="150" maxlength="127"/>
				</td>
				<td style="padding:5px;" style="padding-left:5px" colspan="2" >
			...
			<tr>
				...
				<td style="padding:5px;" class="inputValue">
					<form:textarea style="width:350px;" id="descriptionInput" path="longDescription" rows="10" cols="100"/>
				</td>
